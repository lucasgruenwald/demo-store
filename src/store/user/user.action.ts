...
import { AddtlInfo, UserData } from '../../utils/firebase/firebase.utils';
...
export type SignUpSuccess = ActionWithPayload<
  ...
  { user: User; addtlDetails: AddtlInfo }
>;
...
export const signUpSuccess = withMatcher((user: User, addtlDetails: AddtlInfo): SignUpSuccess =>
  createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, addtlDetails }));
